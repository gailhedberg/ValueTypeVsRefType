...
namespace ValueRefTypes
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Pet coral = new Pet("coral", "dog", 7); //create object pet coral the dog
            Pet chugar = coral; // create pet chugar - who is a reference to coral

            coral.Display();
            chugar.Display();

            Pet cody = new Pet(); //create cody, a new obj. assign him values from other pets
